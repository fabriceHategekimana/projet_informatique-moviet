...
Element.prototype.getNumber = function(i) {
  return this._clines.rtof[i];
};

Element.prototype.getScreenNumber = function(i) {
  return this._clines.ftor[i][0];
};
...
Element.prototype.getScreenLine = function(i) {
